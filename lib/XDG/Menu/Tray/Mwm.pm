...
=head1 NAME
 ...
 XDG::Menu::Tray::Mwm - generate a MWM system tray menu from an XDG::Menu tree

=head1 SYNOPSIS

 my $parser = new XDG::Menu::Parser;
 my $tree = $parser->parse_menu('/etc/xdg/menus/applications.menu');
 my $tray = new XDG::Menu::Tray::Mwm;
 my $menu = $tray->create($tree);

=head1 DESCRIPTION

B<XDG::Menu::Tray::Mwm> is a module that reads an XDG::Menu::Layout
tree and generates a Gtk2 menu for MWM.

=head1 METHODS

B<XDG::Menu::Tray::Mwm> has the following methods:
