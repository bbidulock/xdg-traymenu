...
=head1 NAME
 ...
 XDG::Menu::Tray::Twm - generate a TWM system tray menu from an XDG::Menu tree
...
B<XDG::Menu::Tray::Twm> is a module that reads an XDG::Menu::Layout
tree and generates a Gtk2 menu for TWM.

=head1 METHODS

B<XDG::Menu::Tray::Twm> has the following methods:
